...
import com.zendaimoney.thirdpp.channel.dto.req.allinpay.pay.query.PayQueryReq;
import com.zendaimoney.thirdpp.channel.dto.resp.RespDto;
import com.zendaimoney.thirdpp.channel.dto.resp.allinpay.pay.query.PayQueryResp;
import com.zendaimoney.thirdpp.channel.dto.resp.allinpay.pay.query.RespBody;
...
@ReqActionAnnotation(thirdType = ThirdType.ALLINPAY, bizType = BizType.BROKER_PAY, channelCategory = ChannelCategory.QUERY)
@Component("com.zendaimoney.thirdpp.channel.action.allinpay.PayQueryAction")
