...
import com.zendaimoney.thirdpp.channel.dto.req.allinpay.collect.query.CollectQueryReq;
import com.zendaimoney.thirdpp.channel.dto.resp.RespDto;
import com.zendaimoney.thirdpp.channel.dto.resp.allinpay.collect.query.CollectQueryResp;
import com.zendaimoney.thirdpp.channel.dto.resp.allinpay.collect.query.RespBody;
 ...
 * 
 */
@ReqActionAnnotation(thirdType = ThirdType.ALLINPAY, bizType = BizType.BROKER_COLLECT, channelCategory = ChannelCategory.QUERY)
@Component("com.zendaimoney.thirdpp.channel.action.allinpay.CollectQueryAction")
