 ...
 *
 */
@ReqActionAnnotation(thirdType = ThirdType.YONGYOUUNIONPAY, bizType = BizType.BROKER_PAY, channelCategory = ChannelCategory.QUERY)
@Component("com.zendaimoney.thirdpp.channel.action.yyoupay.YyoupayBidPayQueryAction")
public class YyoupayBidPayQueryAction extends Action {

	// 日志工具类
	private static final LogPrn logger = new LogPrn(YyoupayBidPayQueryAction.class);
	...
	public YyoupayBidPayQueryAction() {
		super();
	}
