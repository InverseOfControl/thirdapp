package com.zendaimoney.thirdpp.channel.communication.shunionpay;
...
@Component
public class ShunionpayCommunication extends GenericCommunication {

	private static final LogPrn logger = new LogPrn(ShunionpayCommunication.class);
	...
	public Message sendMessageByHttp(Message message) throws Exception{
		...
		try {
			...
			String loggerinfo = "communication shunionpay request info ["+message.getRequestInfo()+"]";
			...
			loggerinfo = "communication shunionpay response info ["+responseString+"]";
