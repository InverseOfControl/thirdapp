package com.zendaimoney.thirdpp.channel.exception;
...
public enum PlatformErrorCode {
	...
	CHANNEL_NOT_FOUND_ERROR("200011", "业务通道不存在或已关闭"),
	CHANNEL_PAY_BANK_CLOSE("200012", "第三方支付银行通道维护中或已关闭"),
	CHANNEL_AUTH_THIRD_ERROR("200013", "第三方报文响应错误"),
	THIRD_RESPONSE_NO_MESSAGE_ERROR("200014", "第三方报文响应不存在"),
	;
