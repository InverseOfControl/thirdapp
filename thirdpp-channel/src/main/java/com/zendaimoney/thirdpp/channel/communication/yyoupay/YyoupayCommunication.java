package com.zendaimoney.thirdpp.channel.communication.yyoupay;
...
@Component
public class YyoupayCommunication extends GenericCommunication {

	private static final LogPrn logger = new LogPrn(YyoupayCommunication.class);
	...
	public Message sendMessageByHttp(Message message) throws Exception{
		...
		try {
			...
			String loggerinfo = "communication yyoupay request info ["+message.getRequestInfo()+"]";
			...
			loggerinfo = "communication yyoupay response info ["+responseString+"]";
			logger.info(loggerinfo);
