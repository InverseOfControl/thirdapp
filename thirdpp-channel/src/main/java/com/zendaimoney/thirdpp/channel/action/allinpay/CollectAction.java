...
import com.zendaimoney.thirdpp.channel.dto.resp.allinpay.collect.trade.CollectResp;
import com.zendaimoney.thirdpp.channel.dto.resp.allinpay.collect.trade.RespBody;
 ...
 * 
 */
@ReqActionAnnotation(thirdType = ThirdType.ALLINPAY, bizType = BizType.BROKER_COLLECT, channelCategory = ChannelCategory.TRADE)
@Component("com.zendaimoney.thirdpp.channel.action.allinpay.CollectAction")
