package com.zendaimoney.thirdpp.channel.communication.zendaipay;
...
@Component
public class ZendaipayCommunication extends GenericCommunication {

	private static final LogPrn logger = new LogPrn(ZendaipayCommunication.class);
	...
	public Message sendMessageByHttp(Message message) throws Exception{
		...
		try {
			...
			String loggerinfo = "communication zendaipay request info ["+message.getRequestInfo()+"]";
			...
			loggerinfo = "communication zendaipay response info ["+responseString+"]";
	...
	public Message sendMessageByHttp(Message message, String encodeType) throws Exception{
		...
		try {
			...
			HttpPost httpPost = new HttpPost(message.getUrl());
			String loggerinfo = "communication zendaiAuth request info ["+message.getRequestInfo()+"]";
			logger.info(loggerinfo);
			...
			loggerinfo = "communication zendaiAuth response info ["+responseString+"]";
			logger.info(loggerinfo);
			message.setHttpStatusCode(httpStatusCode);
			message.setResponseInfo(responseString);
			return message;
