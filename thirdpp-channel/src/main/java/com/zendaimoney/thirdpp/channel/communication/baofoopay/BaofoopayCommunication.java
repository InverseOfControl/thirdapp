package com.zendaimoney.thirdpp.channel.communication.baofoopay;
...
@Component
public class BaofoopayCommunication extends GenericCommunication {

	private static final LogPrn logger = new LogPrn(BaofoopayCommunication.class);
	...
	public Message sendMessageByHttp(Message message) throws Exception{
		...
		try {
			...
			String loggerinfo = "communication baofoopay request info ["+message.getRequestInfo()+"]";
			...
			loggerinfo = "communication baofoopay response info ["+responseString+"]";
