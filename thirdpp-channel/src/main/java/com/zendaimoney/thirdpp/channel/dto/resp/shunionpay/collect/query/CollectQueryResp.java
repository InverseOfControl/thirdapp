package com.zendaimoney.thirdpp.channel.dto.resp.shunionpay.collect.query;
...
public class CollectQueryResp extends RespDto{
	...
	public CollectQueryResp decode(String respMsg) throws PlatformException {
		...
		Map<String, String> valueMap = ShunionpayUtil.getResponseMap(respMsg, ChannelCategory.QUERY);
		
		dto = (CollectQueryResp) JSONHelper.json2Object(JSONHelper.map2json(valueMap), dto.getClass());
