 ...
 *
 */
@ReqActionAnnotation(thirdType = ThirdType.CMBPAY, cmbBizType = TrustBizType.PROA, cmbCategory = TrustCategory.TRADE)
@Component("com.zendaimoney.trust.channel.action.pmanager.ProaTradeAction")
public class ProaTradeAction extends TradeActionAbstract {
	
	// 日志工具类
	private static final LogPrn logger = new LogPrn(ProaTradeAction.class);
