...
public class DrslTop implements Serializable {

	private static final long serialVersionUID = 3058891376449341011L;
	...
	// 垫付平台用户号 C
	@CmbAnnotation(index = 5, length = 20, rightFill = true, filler = Constants.BLANK)
	private String advancePlatformUserNo;

	// 垫付平台虚拟户 C
	@CmbAnnotation(index = 6, length = 30, rightFill = true, filler = Constants.BLANK)
	private String advancePlatformVirtualSubNo;

	// 清算成功笔数 C
	@CmbAnnotation(index = 7, length = 6, rightFill = false, filler = Constants.ZERO)
