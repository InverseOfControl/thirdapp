...
/**
 * 用户解绑银行卡(USRJ)Action-交易
 * @author mencius
 *
 */
@ReqActionAnnotation(thirdType = ThirdType.CMBPAY, cmbBizType = TrustBizType.USRJ, cmbCategory = TrustCategory.TRADE)
@Component("com.zendaimoney.trust.channel.action.user.UsrjTradeAction")
public class UsrjTradeAction extends TradeActionAbstract {
	
	// 日志工具类
	private static final LogPrn logger = new LogPrn(UsrjTradeAction.class);
