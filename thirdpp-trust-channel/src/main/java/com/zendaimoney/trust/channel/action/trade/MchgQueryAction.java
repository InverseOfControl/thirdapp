...
/**
 * 平台充值请求(MCHG)Action-查询
 * @author 00233197
 *
 */
@ReqActionAnnotation(thirdType = ThirdType.CMBPAY, cmbBizType = TrustBizType.MCHG, cmbCategory = TrustCategory.QUERY)
@Component("com.zendaimoney.trust.channel.action.trade.MchgQueryAction")
public class MchgQueryAction extends TradeActionAbstract {

	// 日志工具类
	private static final LogPrn logger = new LogPrn(MchgQueryAction.class);
