...
public class AnxiMacUtils {
	...
	public static String xOrString(String pan,String pin)
		 ...
		 * @return	加密后的数据
		 */
		public static String Ansi_X99_Get_MAC(String key,String vector,String data)
		{
			if(key.length() != 16)
			{
...
//			String key = "B3059C7BAD842AC0";
//			String str = "This is an example.";
//			String str = "1000001             mencius                                                                                                                                                         P101411421198706123270            18221374856                                                                                                                                                                                                        ";
//			String str_hex = "5468697320697320616E206578616D706C652E";
//			RESULT = 779F0A084090EA0D
//			System.out.println(str + " > 经过ANSIX9.9加密 > " + Ansi_X99_Get_MAC(key, null, str_hex));
			
			String str = "招商银行";
			System.out.println(str + " > 由字符串转换为16进制 > " + ConvertUtils.strToHex(str, "gbk"));
			
//			System.out.println(str + " > 由字符串转换为16进制 > " + ConvertUtils.strToHex(str, "gbk"));
//			
//			String str_hex = "D3C3BBA7C0E0D0CD5B505DBDFBD6B9D6A4BCFEC0E0D0CD5B3130315D                                                                                                        ";
//			System.out.println(str_hex + " > 由16进制转换为字符串  > " + HEX_2_ASC(str_hex));
			
//			System.out.println(ByteUtil.getHexStr(str_hex.getBytes()));
		}
