...
public class MrslDetailReq implements Serializable {
	...
	// 交易返回码 C
	@CmbAnnotation(index = 5, length = 7, rightFill = true, filler = Constants.BLANK)
	private String retCode;

	// 交易返回描述信息 C
	@CmbAnnotation(index = 6, length = 80, rightFill = true, filler = Constants.BLANK)
