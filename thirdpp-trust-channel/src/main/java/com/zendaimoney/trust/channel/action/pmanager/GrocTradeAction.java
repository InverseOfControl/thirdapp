 ...
 *
 */
@ReqActionAnnotation(thirdType = ThirdType.CMBPAY, cmbBizType = TrustBizType.GROC, cmbCategory = TrustCategory.TRADE)
@Component("com.zendaimoney.trust.channel.action.pmanager.GrocTradeAction")
public class GrocTradeAction extends TradeActionAbstract {
	
	// 日志工具类
	private static final LogPrn logger = new LogPrn(GrocTradeAction.class);
