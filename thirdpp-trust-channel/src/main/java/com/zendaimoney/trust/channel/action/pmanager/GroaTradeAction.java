...
/**
 * 登记团信息(GROA)Action-交易
 * @author mencius
 *
 */
@ReqActionAnnotation(thirdType = ThirdType.CMBPAY, cmbBizType = TrustBizType.GROA, cmbCategory = TrustCategory.TRADE)
@Component("com.zendaimoney.trust.channel.action.pmanager.GroaTradeAction")
public class GroaTradeAction extends TradeActionAbstract {
	
	// 日志工具类
	private static final LogPrn logger = new LogPrn(GroaTradeAction.class);
