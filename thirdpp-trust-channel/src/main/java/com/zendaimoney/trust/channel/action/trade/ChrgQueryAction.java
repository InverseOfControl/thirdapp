 ...
 *
 */
@ReqActionAnnotation(thirdType = ThirdType.CMBPAY, cmbBizType = TrustBizType.CHRG, cmbCategory = TrustCategory.QUERY)
@Component("com.zendaimoney.trust.channel.action.trade.ChrgQueryAction")
public class ChrgQueryAction extends TradeActionAbstract {

	// 日志工具类
	private static final LogPrn logger = new LogPrn(ChrgQueryAction.class);
