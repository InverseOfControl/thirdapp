 ...
 *
 */
public class BatchActionTarget {

	/**
	 * 
	 */
	private Class<? extends BatchActionAbstract> actionClazz;
	...
	public BatchActionTarget(Class<? extends BatchActionAbstract> actionClazz,
	...
	public Class<? extends BatchActionAbstract> getActionClazz() {
		return actionClazz;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BatchActionTarget other = (BatchActionTarget) obj;
