...
public class ClassUtil {
	...
	public static final String ITSM_PACKAGE = "com.zendaimoney.trust.channel.action";

	private static final LogPrn log = new LogPrn(ClassUtil.class);
	...
	public static List<Class> getClassClasses(String packageName, boolean recursion) {
	...
	public static void main(String[] args) {
		// List<String> list = getClassPathClassNames(ITSM_PACKAGE, true);
		// for(String className : list) {
		// System.out.println(className);
		// }
		Class<? extends TradeActionAbstract> actionClass = TradeActionAbstract.class;
		List<Class<? extends TradeActionAbstract>> list = getClassPathClasses(ITSM_PACKAGE, true, actionClass);
