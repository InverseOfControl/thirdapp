...
public class ThirdFieldMapper implements Serializable {
	...
	// 字段映射类型-证件类型
	public static final String FIELD_TYPE_ID_TYPE = "3";
	
	// 字段映射类型-用户类型
	public static final String FIELD_TYPE_PUB_AND_PRI_TYPE = "4";
		
	// 字段映射类型-用户类型
	public static final String FIELD_TYPE_USER_TYPE = "5";
	
	// 字段映射类型-交易类别
	public static final String FIELD_TYPE_TRADE_TYPE = "6";
