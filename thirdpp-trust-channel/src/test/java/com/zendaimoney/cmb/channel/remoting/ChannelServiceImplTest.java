...
//		vo.setTrustBizType(TrustBizType.USRA);
		...
		System.out.println("业务类型："+TrustBizType.USRA);
//		System.out.println("业务类型："+TrustBizType.USRB);
...
//		vo.setBizSysNo(BizSys.ZENDAI_2001_SYS.getCode());
		vo.setBizSysNo("333");
//		System.out.println("系统号："+BizSys.ZENDAI_2001_SYS.getCode());
		vo.setTradeFlow("0050000000000026");
//		vo.setTradeFlow("005"+CalendarUtils.getFormatNow());
//		vo.setTradeFlow(CalendarUtils.getFormatNow());
		...
		vo.setUserNo("102999"); // 用户号1000001(已开)
...
//		CMBAUSRA88880216542016022400008SC.TXT
		vo.setReqFileName("CMBAUSRA88880216542016022400008SC.TXT");
...
/*		UsrdReq vo = new UsrdReq();
		...
		vo.setInfoCategoryCode("10026");
		vo.setBizSysNo(BizSys.ZENDAI_2001_SYS.getCode());
		vo.setTradeFlow("01969366142863");
		vo.setTradeDate(CalendarUtils.getShortFormatNow());
		vo.setTradeTime(CalendarUtils
				.getFormatNow(CalendarUtils.SHORT_FORMAT_TIME));

		vo.setUserNo("65821"); // 用户号
		vo.setVirtualSubNo("1219001002134010000000136"); // 用户虚拟子账户号(1219001002134010000000201,msg:用户不存在,BankRepCode:CMBUS02)
		...
		*/
		   ...
		   String UserNo="22685";//客户编号
		   String VirtualSubNo="1219001002134010000000174";//虚拟子账户
			UsrdReq vo = new UsrdReq();
			vo.setTrustBizType(TrustBizType.USRD);
			vo.setTrustCategory(TrustCategory.TRADE);
			vo.setThirdType(ThirdType.CMBPAY);
			...
			vo.setInfoCategoryCode("10026");
			vo.setBizSysNo(BizSys.ZENDAI_2001_SYS.getCode());
			vo.setTradeFlow("20160408204610");
			vo.setTradeDate(CalendarUtils.getShortFormatNow());
			vo.setTradeTime(CalendarUtils.getFormatNow(CalendarUtils.SHORT_FORMAT_TIME));
			
			vo.setUserNo(UserNo); 
	        vo.setVirtualSubNo(VirtualSubNo);
	...
	public void mdrwCommand() {
		...
		vo.setTrustBizType(TrustBizType.MDRW);
		vo.setTrustCategory(TrustCategory.TRADE);
		vo.setThirdType(ThirdType.CMBPAY);
		vo.setInfoCategoryCode("10026");
		vo.setBizSysNo(BizSys.ZENDAI_2001_SYS.getCode());
