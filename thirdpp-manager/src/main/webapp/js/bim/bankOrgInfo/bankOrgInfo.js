 ...
 */
function editUI(id){
	window.location.href = contextPath+"/bim/bankOrgInfo/bankOrgInfoEditUI/"+id;
}
 ...
 */
function cancel() {
   window.location.href = contextPath+"/bim/bankOrgInfo/bankOrgInfoList";
}
