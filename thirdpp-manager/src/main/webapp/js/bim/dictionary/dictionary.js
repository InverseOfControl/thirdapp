...
function formReset(){
	...
	$("#dictionaryForm select").select2('val','');
 ...
 */
function editUI(id){
	window.location.href = contextPath+"/bim/dictionary/dictionaryEditUI/"+id;
}
 ...
 */
function cancel() {
   window.location.href = contextPath+"/bim/dictionary/dictionaryList";
}
