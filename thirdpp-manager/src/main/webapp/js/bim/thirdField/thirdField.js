 ...
 */
function editUI(id){
	window.location.href = contextPath+"/bim/thirdField/thirdFieldEditUI/"+id;
}
 ...
 */
function cancel() {
   window.location.href = contextPath+"/bim/thirdField/thirdFieldList";
}
