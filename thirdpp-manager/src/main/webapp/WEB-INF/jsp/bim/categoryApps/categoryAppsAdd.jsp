		...
		<form id="infoCategoryAppsSave" method="post"
			...
			<table class="search-table">
				...
				<tr>
					...
					<input type="hidden" id="appCodeValue" value="${appCodealue}" />
					<td><input name="infoCateGoryCode" type="text"
						style="width: 200px"
						...
						class="easyui-validatebox" /> <input type="hidden" id="noteNo"
						name="noteNo" class="easyui-textbox"
						value="${categoryApps.noteNo}"
						data-options="required:true,novalidate:true" /> <span
				...
				<tr>
					...
					<td><input name="infoCateGoryName" type="text"
						...
						class="easyui-validatebox" /> <span style="color: red">*</span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input id="appsCode" name="appCode" style="width: 200px"
						...
						data-options="
											editable:false, 
										   multiple: 'true',
										  url:'${path}/enumset/bizSysNoList/allcombobox',
				...
				<tr>
					...
					<td><input style="width: 200px" name="channelRule"
						...
						data-options="editable:false,data:[{'type':'1','text':'按业务系统指定通道'},{'type':'2','text':'按银行指定通道'},{'type':'3','text':'按路由规则指定通道'}],	valueField:'type',textField:'text',value:'1'" />
					</td>
				</tr>
				<tr>
