						...
						<table class="search-table">
								...
								<tr>
									...
									<td><input type="text" id="dicName" name="dicName" class="easyui-validatebox"
										...
										data-options="required:true,novalidate:true,invalidMessage:'最大长度不能超过50',validType:'maxLength[50]'"   /><span style="color:red">*</span>
										<input type="hidden" id="dicCode" name="dicCode"
										value="${dictionary.dicCode}" style="width: 200px;" class="easyui-validatebox" maxlength="50"
