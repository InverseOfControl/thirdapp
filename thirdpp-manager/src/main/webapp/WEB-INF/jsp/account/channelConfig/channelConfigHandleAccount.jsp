...
<div class="content-body">
		<div class="search-panel-content">
			<form id="handleTppAccountChannelConfigFrom" name="handleTppAccountChannelConfigFrom" method="post" action="editTppAccountChannelConfigAction.action">
				<div class="search-panel-bd">
					<table class="search-table">
						 <tr>
							<th class="wd-20"><label>通道配置ID</label></th>
							<td>
							...
							<td>
								...
								data-options="required:true,
								              ...
								              onSelect:function(date) {
		    			        				 ...
		    			        				 if (d1 < date) {
		    			        						 $.messager.alert('提示','通道手工对账只能选择当天或者当天之前的日期');
