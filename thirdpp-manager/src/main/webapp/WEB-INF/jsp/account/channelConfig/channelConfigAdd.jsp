...
<div class="content-body">
		<div class="search-panel-content">
			<form id="addTppAccountChannelConfigFrom" name="addTppAccountChannelConfigFrom" method="post" action="${path}/account/channelConfig/addChannelConfig">
				<div class="search-panel-bd">
				 <table class="search-table">
						 <tr>
							<th class="wd-20"><label>第三方支付平台</label></th>
							<td>
								<!-- <input type="text" id="channelName" name="channelName" class="easyui-validatebox" data-options="required:true,missingMessage:'通道名称不能为空',novalidate: true,validType:'maxLength[100]'" style="width:150px;"/><span style="color:red">*</span> -->
								<input id=thirdTypeNo class="easyui-combobox" name="thirdTypeNo" data-options="
									editable:false,valueField: 'value',
									textField: 'name',
									//url是下拉框请求显示的数据
									url:'${path }/enumset/dictionary/3' " style="width:150px;"/><span style="color:red">*</span>
							</td>
							<!-- <th class="wd-20"><label>渠道编码</label></th>
							<td>
								<input type="text" id="thirdTypeNo" name="thirdTypeNo" class="easyui-validatebox" data-options="required:true,missingMessage:'渠道编码不能为空',novalidate: true,validType:'maxLength[10]'" style="width:150px;"/><span style="color:red">*</span>
							</td> -->
						 ...
						 <tr>
							...
							<td>
								<input type="text" id="merchantNo" name="merchantNo" class="easyui-validatebox" data-options="required:true,missingMessage:'商户号不能为空',novalidate: true,validType:'maxLength[100]'" style="width:150px;"/><span style="color:red">*</span>
							</td>
							...
							<td>
								...
								<input id="fetchMethod" class="easyui-combobox" name="fetchMethod" data-options="
										...
										textField: 'name',
										//url是下拉框请求显示的数据
										url:'${path }/enumset/getAccountFetchMethodList'" style="width:150px;"/><span style="color:red">*</span>
							</td>
						  </tr>
						 <tr>
							...
							<td>
								...
								<input id="fetchType" class="easyui-combobox" name="fetchType" data-options="
										...
										textField: 'name',
										//url是下拉框请求显示的数据
										url:'${path }/enumset/getAccountFetchTypeList'" style="width:150px;"/><span style="color:red">*</span>
							</td>
							<th class="wd-20"><label>HTTP请求下载地址</label></th>
							<td>
								<input type="text" id="downloadUrl" name="downloadUrl" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[100]'" style="width:150px;"/>
							</td>
						  </tr>
						 <tr>
							<th class="wd-20"><label>FTP请求登录用户名</label></th>
							<td>
								<input type="text" id="loginUsername" name="loginUsername" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[100]'" style="width:150px;"/>
							</td>
							<th class="wd-20"><label>FTP请求登录密码</label></th>
							<td>
								<input type="text" id="loginPwd" name="loginPwd" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[100]'" style="width:150px;"/>
							</td>
						  </tr>
						 <tr>
							<th class="wd-20"><label>FTP请求文件存放目录</label></th>
							<td>
								<input type="text" id="filePath" name="filePath" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[200]'" style="width:150px;"/>
							</td>
							<!-- <th class="wd-20"><label>FTP请求文件备份目录</label></th>
							<td>
								<input type="text" id="fileBackupPath" name="fileBackupPath" class="easyui-validatebox" data-options="required:true,novalidate: true,validType:'maxLength[200]'" style="width:150px;"/>
							</td> -->
						 ...
						 <tr>
							...
							<td>
								<input type="text" id="fileNameFormat" name="fileNameFormat" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[100]'" style="width:150px;"/>
							</td>
							<th class="wd-20"><label>文件后缀名</label></th>
							<td>
								<input type="text" id="fileSuffix" name="fileSuffix" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[10]'" style="width:150px;"/>
							</td>
						  </tr>
						 <tr>
							<th class="wd-20"><label>从第几行开始读取记录</label></th>
							<td>
								<input type="text" id="fileStartIndex" name="fileStartIndex" class="easyui-validatebox" data-options="required:true,missingMessage:'第几行开始读取记录不能为空',novalidate: true,validType:['maxLength[2]','Number']" style="width:150px;"/><span style="color:red">*</span>
							</td>
						 ...
						 <tr>
							...
							<td>
								<input type="text" id="attrSplit" name="attrSplit" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[2]'" style="width:150px;"/>
							</td>
							...
							<td>
								<input id="status" class="easyui-combobox" name="status" data-options="
										...
										value:'1' " style="width:150px;"/><span style="color:red">*</span>
							</td>
						  </tr>
						 <tr>
							...
							<td>
								<input id="currency" class="easyui-combobox" name="currency" data-options="
										...
										textField: 'name',
										//url是下拉框请求显示的数据
										url:'${path }/enumset/dictionary/0'" style="width:150px;"/><span style="color:red">*</span>
							</td>
						 ...
						 <tr>
							...
							<td>
								<input type="text" id="server" name="server" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[100]'" style="width:150px;"/>
							</td>
							<th class="wd-20"><label>FTP端口号</label></th>
							<td>
								<input type="text" id="port" name="port" class="easyui-validatebox" data-options="required:true,missingMessage:'不能为空',novalidate: true,validType:'Number'" style="width:150px;"/><span style="color:red">*</span>
							</td>
						 </tr>
						 <tr>
						 	<th class="wd-20"><label>FTP请求文件存放子目录 </label></th>
							<td>
								<input type="text" id="filePathSub" name="filePathSub" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[200]'" style="width:150px;"/>
							</td>
						 ...
						 <tr>
							...
							<td>
								<input type="text" id="maxDownloadFailedTimes" name="maxDownloadFailedTimes" class="easyui-validatebox" data-options="required:true,missingMessage:'不能为空',novalidate: true,validType:'Number'" value="0" style="width:150px;"/><span style="color:red">*</span>
							</td>
							<th class="wd-20"><label>入库操作最多失败次数</label></th>
							<td>
								<input type="text" id="maxInsertFailedTimes" name="maxInsertFailedTimes" class="easyui-validatebox" data-options="required:true,missingMessage:'不能为空',novalidate: true,validType:'Number'" value="0" style="width:150px;"/><span style="color:red">*</span>
							</td>
						  </tr>
						 <tr>
							<th class="wd-20"><label>备份操作最多失败次数</label></th>
							<td>
								<input type="text" id="maxBackupFailedTimes" name="maxBackupFailedTimes" class="easyui-validatebox" data-options="required:true,missingMessage:'不能为空',novalidate: true,validType:'Number'" value="0" style="width:150px;"/><span style="color:red">*</span>
							</td>
						 	<th class="wd-20"><label>最大对账失败次数</label></th>
							<td>
								<input type="text" id="maxAccountFailedTimes" name="maxAccountFailedTimes" class="easyui-validatebox" data-options="required:true,missingMessage:'不能为空',novalidate: true,validType:'Number'" value="0" style="width:150px;"/><span style="color:red">*</span>
							</td>
						 </tr>
						 <tr>
						 	<th class="wd-20"><label>汇总信息所在行</label></th>
							<td>
								<input type="text" id="fileHeaderAttrsIndex" name="fileHeaderAttrsIndex" class="easyui-validatebox" data-options="novalidate: true,validType:'maxLength[10]'" style="width:150px;"/>
						 ...
						 <tr>
						 	...
						 	<td>
						        ...
						        <br/>
						        <br/>
						        <select multiple="multiple" id="attrsDefinition" name="attrsDefinition" style="width: 150px;height:160px;"><span style="color:red">*</span>
						        </select>
						   </td>
						   <%-- <th class="wd-20"><label>文件头属性定义</label></th>
						 	<td>
						        ...
						        <br/>
						        <br/>
						        <select multiple="multiple" id="headerAttrsDefinition" name="headerAttrsDefinition" style="width: 150px;height:160px;"><span style="color:red">*</span>
						        </select>
						   </td> --%>
						 </tr>
				  </table>
