...
<div class="content-body">
		<div class="search-panel-content">
			<form id="editTppTradeTPayInfoFrom" name="editTppTradeTPayInfoFrom" method="post" action="editTppTradeTPayInfoAction.action">
				<div class="search-panel-bd">
					<table class="search-table">
							 ...
							 <tr>
								...
								<th class="wd-20"><label>收款方银行编码</label></th>
								<td>
									<input type="text" id="receiver_bank_code" name="receiver_bank_code"  value="${receiver_bank_code}" style="width:200px;" readonly="true" />
								</td>
							  </tr>
							  <tr>
							 ...
							 <tr>
								...
								<th class="wd-20"><label>支付渠道交易返回流水号</label></th>
								<td>
							...
							<tr>
							 ...
							 <tr>
								...
								<th class="wd-20"><label>通知合并状态</label></th>
								<td>
							 ...
							 <tr>
								<th class="wd-20"><label>对账日期</label></th>
								<td>
