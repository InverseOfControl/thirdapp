...
<body class="easyui-layout">
			...
			<div class="easyui-panel" title="查询条件" style="padding:5px;height:143px;margin: 0px;" data-options="region:'north'">
				<form id="searchForm" name="searchForm" method="post" >
					<table cellpadding="5">
						...
						<tr>
								...
								<td>
									<input type="text" id="search_receiver_info" name="search_receiver_info" class="grayTips"   value="姓名/银行卡号/证件号" style="width:200px;"/>
								</td>
				...
				<form id="exportPayTaskExcelForm" name="exportPayTaskExcelForm" method="post">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_tppTradeTPayTask" class="easyui-datagrid" 
					data-options="rownumbers:true,pageSize:20,singleSelect:true,collapsible:true,sortName:'',pagination:'true',sortOrder:'desc',url:'${path}/trade/pay/listData/null',method:'post',toolbar:toolbar,fit:'true',onLoadSuccess:function(){loadSummary();$(this).datagrid('fixRownumber');},onBeforeLoad:function(param){loadBefore(param)},onClickRow: function (rowIndex, rowData) {$(this).datagrid('unselectRow', rowIndex);}">
					...
					<thead>
						<tr>
							...
							<th data-options="field:'APP_NAME',width:120,sortable:false,align:'right'">业务系统</th>
...
jQuery(function($){
	...
	$('#export_btn').click(function(){
		...
		var exporForm="#exportPayTaskExcelForm";
		$(exporForm).form({   
			 url:'${path}/trade/pay/exportPayTaskExcel',    
		     onSubmit: function(){
...
function loadSummary(){
	...
	if (search_receiver_info=='姓名/银行卡号/证件号') {
  	...
  	$.ajax({
		url:'${path}/trade/pay/summaryData/null',
		data:{"search_begin_date":search_begin_date,"search_end_date":search_end_date,"search_biz_sys_no":search_biz_sys_no,"search_pay_sys_no":search_pay_sys_no,"search_send_status":search_send_status,"search_trade_status":search_trade_status,"search_biz_flow":search_biz_flow,"search_biz_type":search_biz_type,"search_info_category":search_info_category,"search_receiver_info":search_receiver_info, "search_receiver_type":search_receiver_type, "search_bank_code":search_bank_code},
		dataType:"JSON",
		type:"POST",
		async:true,
