...
public class ClassUtil {
	...
	public static final String ITSM_PACKAGE = "com.zendaimoney.thirdpp.transfer.action";
	...
	public static void main(String[] args) {
		...
		List<Class<? extends Action>> list = getClassPathClasses(ITSM_PACKAGE, true, actionClass);
