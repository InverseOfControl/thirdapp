...
import com.zendaimoney.thirdpp.transfer.mongo.DBManager;
import com.zendaimoney.thirdpp.transfer.mongo.MongoDataSource;
...
public class MongoDBUtils {
	...
	public void loadFromFile(String path) {
		try {
			...
			throw new PlatformException(ExceptionUtil.getExceptionMessage(e));
		} catch (Exception e) {
			logger.error("Parse configuration failed,path=" + path);
			throw new PlatformException(ExceptionUtil.getExceptionMessage(e));
		}
