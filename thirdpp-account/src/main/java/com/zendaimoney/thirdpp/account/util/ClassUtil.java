...
public class ClassUtil {
	...
	public static final String ACTION_ITSM_PACKAGE = "com.zendaimoney.thirdpp.account.action";
	
	public static final String FILTER_ITSM_PACKAGE = "com.zendaimoney.thirdpp.account.filter";
