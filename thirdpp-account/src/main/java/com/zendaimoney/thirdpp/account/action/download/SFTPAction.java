...
@DownloadActionAnnotation(fetchMethod = Constants.FETCH_METHOD_SFTP)
@Component("com.zendaimoney.thirdpp.account.action.download.SFTPAction")
public class SFTPAction extends DownloadAction {
