...
public class CalendarUtils {
	...
	/** 完整日期时间无间隔格式 */
	public static final String LONG_FORMAT_BLAS = "yyyy/MM/dd HH:mm:ss";
	...
	public static final String DEFAULT_TIME_FORMAT_TIME_COLON = "000000";
	/**
	 * 无间隔天格式
	 */
	...
	public static String getFormatNowWIthBlas(){
		return parsefomatCalendar(Calendar.getInstance(), CalendarUtils.LONG_FORMAT_BLAS);
	}
	...
	public static String getShortLineFormatDay(){
		return parsefomatCalendar(Calendar.getInstance(), CalendarUtils.SHORT_FORMAT_LINE);
	}
	...
	public static Date convertTimeFormatStringToDate(String timeFormatString){
		SimpleDateFormat sdf = new SimpleDateFormat(LONG_FORMAT);
		try {
			return sdf.parse(timeFormatString);
		} catch (ParseException e) {
			throw new PlatformException("时间格式转化为日期错误",e);
		}
	}
