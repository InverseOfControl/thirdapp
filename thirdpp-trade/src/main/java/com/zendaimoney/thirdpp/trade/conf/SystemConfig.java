package com.zendaimoney.thirdpp.trade.conf;
...
public class SystemConfig implements Serializable {
	...
	private String oracleUniqeErrorCode;
	...
	public String getOracleUniqeErrorCode() {
		return oracleUniqeErrorCode;
	}

	public void setOracleUniqeErrorCode(String oracleUniqeErrorCode) {
		this.oracleUniqeErrorCode = oracleUniqeErrorCode;
	}
