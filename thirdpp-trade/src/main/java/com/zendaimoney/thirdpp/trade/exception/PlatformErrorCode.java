package com.zendaimoney.thirdpp.trade.exception;
...
public enum PlatformErrorCode {
	...
	REPEAT_TRADE_ERROR("200011","业务流水号存在，重复报盘"),
	NOT_EXISTS_SYSTEM("200012","业务系统不存在或已关闭"),
	ACCESS_WHITELIST_PERMISSION_ERROR("200013","不在请求白名单列表内"),
	NOT_EXISTS_TRADE_INFO("200014","查无此交易记录"),
	NOT_EXISTS_SIGN_MESSAGE_INFO("200015","原交易流水号不存在"),
	;
