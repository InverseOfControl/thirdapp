...
import com.zendaimoney.thirdpp.trade.entity.SysQueryInfo;

@Repository
public class SysQueryInfoDao extends BaseDao<SysQueryInfo> {
	
	// SysQueryInfo实体类数据库操作前缀.
		private static final String SQL_PREFIX_SYSQUERYINFO = "com.zendaimoney.thirdpp.trade.entity.SysQueryInfo";
