...
public enum BizType {
	...
	TRUST_CHANGE_CARD("016","资金托管换卡"),
	TRUST_UNBIND_CARD("017","资金托管解绑"),
	BIN_QUERY("018","卡bin查询"),
	TRUST_GOPER("019", "资金托管普通操作"),
	TRUST_FROZ("020", "资金托管资金冻结"),
	TRUST_UNFR("021", "资金托管资金解冻"),
	TRUST_SETTLE("022", "资金托管资金清算"),
	TRUST_CLEARING("023", "资金托管资金清分"),
	AGREEMENT_SIGN("024","协议支付签约"),
	AGREEMENT_END_SIGN("025", "协议支付解约");
